...
export const TILE_DEFS = [
  ...
  { id: 'solid', label: 'Solid', color: '#30283b', collides: true },
  { id: 'platform', label: 'Platform', color: '#d8bd72', oneWay: true },
  { id: 'glass', label: 'Glass', color: '#bfeaff', breakable: true },
  { id: 'ladder', label: 'Ladder', color: '#b88751', climbable: true },
  { id: 'backdrop', label: 'Backdrop', color: '#5b5366' },
  { id: 'void', label: 'Void', color: '#090d14' },
  { id: 'pickup', label: 'Pickup', color: '#89e072', marker: true },
